...
5. **Generate report figures:**
   ...
   # writes confusion matrix, per-class F1, top-k accuracy curve,
   # confidence histogram, class distribution, and top features
...
reserved for Abel's contribution. For Canvas submission, render the markdown
to PDF (e.g. `pandoc reports/final_report.md -o reports/final_report.pdf`).
